...
#
# Usage:
#   sh rotate-new-api-keys.sh              # Interactive: prints keys, prompts to update .env.supabase
#   sh rotate-new-api-keys.sh --update-env # Prints keys and writes them to .env.supabase
#   sh rotate-new-api-keys.sh | tee keys   # Non-interactive: prints keys only
#
# Prerequisites:
#   - .env.supabase file (run generate-keys.sh and add-new-auth-keys.sh first)
#   - node >= 16
#
